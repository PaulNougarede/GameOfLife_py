...
def pageAccueil():
    ...
    imageMenuAccueil = pygame.image.load("images/menuAccueil.png").convert_alpha()
    ...
    while running: #boucle infinie
        ...
        draw_text("LE JEU DE LA VIE", pygame.font.SysFont("Futura", 150), (255, 255, 255), 250, 300)
        draw_text("Imad MRROUCH / Victor MIRIEU DE LABARRE / Paul NOUGAREDE / Vinciane GUYONNEAU", pygame.font.SysFont("Futura", 30), (255, 255, 255), 250, 750)
        ...
        bouton_rect = pygame.draw.rect(screen, (255, 255, 255), (525, 450, 300, 100))#affichage bouton
        ...
        if bouton_rect.collidepoint(pygame.mouse.get_pos()):#si souris sur le bouton
            if pygame.mouse.get_pressed()[0]:#si clic
                    ...
                    draw_text("JOUER", pygame.font.SysFont("Futura", 80), (255, 255, 255), 580, 475)
                    pygame.display.flip()
